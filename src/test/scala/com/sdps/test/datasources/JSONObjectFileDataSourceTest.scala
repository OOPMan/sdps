...
class JSONObjectFileDataSourceTest extends FunSuite with BeforeAndAfterAll {
    ...
    val jsonObjects = List(
        ...
        ("field1" -> "string3") ~ ("field2" -> 3) ~ ("field3" -> 4.0) ~ ("field4" -> true)  ~ ("field5" -> List(3,4,5)) ~ ("field6" -> ("a" -> 3) ~ ("b" -> 6) ~  ("c" -> 9)),
        ("field1" -> "string4") ~ ("field2" -> 4) ~ ("field3" -> 5.0) ~ ("field4" -> false) ~ ("field5" -> List(4,5,6)) ~ ("field6" -> ("a" -> 4) ~ ("b" -> 8) ~  ("c" -> 12)),
        ("field1" -> "string5") ~ ("field2" -> 5) ~ ("field3" -> 6.0) ~ ("field4" -> true)  ~ ("field5" -> List(5,6,7)) ~ ("field6" -> ("a" -> 5) ~ ("b" -> 10) ~ ("c" -> 15)),
